...
TODO:   (сделано что-то похожее)вынести юзера в неймспейс
        ...
        конфликт на контрактах когда несуществующего фрилансера вводишь
        лучше как то поправить эти хранимые процедуры которые типо удаляют полдьзователя, надо транзакции изучить
